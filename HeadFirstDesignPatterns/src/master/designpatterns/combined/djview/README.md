...
tomcat/webapps/djview/WEB-INF/classes/master.designpatterns.combined/djview/

11. Copy the following classes from master.designpatterns.combined/djview/ to the
tomcat/webapps/djview/WEB-INF/classes/master.designpatterns.combined/djview/
folder:
   * BeatModel.class 
